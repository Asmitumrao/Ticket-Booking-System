...
import { handleError, handleSuccess } from '../utils/Toaster.jsx';
...
const Form = ({ setIsRegistered }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const { email, password, confirmPassword, name, phone } = signUpdata;
    ...
    try {
      ...
      const response = await axios.post(`${serverUrl}/api/v1/auth/register`, payload, {
        headers: {
      ...
      <div className="form-container">
        ...
        <form className="form" onSubmit={handleSubmit}>
          ...
          <div className="input-group">
            ...
            <input type="tel" name="phone" id="phone" value={signUpdata.phone} onChange={handleChange} />
          </div>
          <div className="input-group">
          ...
          <div className="input-group">
            ...
            <input type="password" name="confirmPassword" id="confirmPassword" value={signUpdata.confirmPassword} onChange={handleChange} />
          </div>
